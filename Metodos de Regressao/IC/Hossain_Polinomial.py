...
previsoes_train = regressor.predict(X_train_poly)
previsoes_test = regressor.predict(X_test_poly)
...
#Calculo do Score
score_train = regressor.score(X_train_poly, y_train)
score_test = regressor.score(X_test_poly, y_test)
