                ...
                for y5 in x5:
                    ...
                    for i in range (100):
                        ...
                        if(score_test > best_score_test):
                            ...
                            best_config = "x1 = %s, x2 = %s, x3 = %s, x4 = %s, x5 = %s" %(y1,y2,y3,y4,y5)
...
standard_RMSE_train = []
standard_RMSE_test = []
standard_SCORE_train = []
standard_SCORE_test = []

for i in range (len(listaSCORE_test)):
    if (listaSCORE_test[i] > 0.70 and abs(listaSCORE_train[i] - listaSCORE_test[i]) < 0.04):
        standard_posicao.append(i)
        standard_dif.append(abs(listaSCORE_train[i] - listaSCORE_test[i]))
        standard_config.append(listaConfig[i])
        standard_MAE_train.append((listaMAE_train[i]))
        standard_MAE_test.append((listaMAE_test[i]))
        standard_MSE_train.append((listaMSE_train[i]))
        standard_MSE_test.append((listaMSE_test[i]))
        standard_RMSE_train.append((listaRMSE_train[i]))
        standard_RMSE_test.append((listaRMSE_test[i]))
        standard_SCORE_train.append((listaSCORE_train[i]))
        standard_SCORE_test.append((listaSCORE_test[i]))